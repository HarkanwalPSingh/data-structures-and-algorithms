...
class BinarySearchTree {
    ...
    breadthFirstSearchRecursive(queue, list){
        ...
        let outputList = this.breadthFirstSearchRecursive(queue, list)
        return outputList
    }
    ...
    depthFirstSearchInorder(currentNode, list){
        ...
        list = this.depthFirstSearchInorder(currentNode.left, list)
        list.push(currentNode.value)
        list = this.depthFirstSearchInorder(currentNode.right, list)

        return list
    }

    depthFirstSearchPreorder(currentNode, list){
        if (currentNode === null){
            return list
        }
        list.push(currentNode.value)
        list = this.depthFirstSearchPreorder(currentNode.left, list)
        list = this.depthFirstSearchPreorder(currentNode.right, list)

        return list
    }

    depthFirstSearchPostorder(currentNode, list){
        if (currentNode === null){
            return list
        }

        list = this.depthFirstSearchPostorder(currentNode.left, list)
        list = this.depthFirstSearchPostorder(currentNode.right, list)
        list.push(currentNode.value)
